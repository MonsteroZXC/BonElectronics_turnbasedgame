...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    Hero vaughnLauron = new Hero("Gio Hernandez", 3500,100,65,100,15,25,10);
    Monster tardyNess = new Monster("tardy Ness", 1600,100,100,150,15,25,10);
    ...
    protected void onCreate(Bundle s) {
        ...
        txtHeroName.setText(vaughnLauron.getUnitName());
        txtMonsName.setText(tardyNess.getUnitName());
        ...
        txtHeroHP.setText(String.valueOf(vaughnLauron.getBaseHealth()));
        txtMonsHP.setText(String.valueOf(tardyNess.getBaseHealth()));
        /** to display the damage ranges of of player and enemy, i showed the minimum damage, the the maximum possible damage **/
        txtHeroDPT.setText(vaughnLauron.getMinDPT()+ " ~ "+vaughnLauron.getMaxDPT());
        txtMonsDPT.setText(tardyNess.getMinDPT()+ " ~ "+tardyNess.getMaxDPT());
    ...
    public void onClick(View v){
        ...
        int heroDPT = randomizer.nextInt(vaughnLauron.getMaxDPT() - vaughnLauron.getMinDPT()) + vaughnLauron.getMinDPT();
        int monsDPT = randomizer.nextInt(tardyNess.getMaxDPT() - tardyNess.getMinDPT()) + tardyNess.getMinDPT();
        ...
        switch (v.getId()){
            case R.id.btnNextTurn:
                ...
                if(turnNumber%2 == 1){
                    ...
                    tardyNess.setBaseHealth(tardyNess.getBaseHealth() - heroDPT);
                    turnNumber++;
                    ...
                    if (tardyNess.getBaseHealth() < 0){
                        txtCombatLog.setText("The Player dealt " +heroDPT+ " damage to the Enemy. "+vaughnLauron.getUnitName()+" was Victorious!");
                        vaughnLauron.setBaseHealth(1500);
                        tardyNess.setBaseHealth(1000);
                        turnNumber = 1;
